    ...
    return (
        <div className="relative w-full">
            ...
            <div className="relative border border-white/15 rounded-2xl p-5 md:p-4 shadow-2xl"
                ...
                <div className="relative grid grid-cols-2 gap-4 md:gap-2">
                    {stats.map((stat, index) => (
                        <motion.div
                            ...
                            className="flex flex-col items-center justify-center text-center gap-2 md:gap-1.5 p-4 md:p-3 rounded-xl bg-white/5 hover:bg-white/8 border border-white/8 hover:border-primary/30 transition-all duration-300 group min-h-[100px] md:min-h-[90px]"
                        >
                            <div className="bg-gradient-to-br from-primary/25 to-primary/10 p-2.5 md:p-2 rounded-full border border-primary/30">
                                <stat.icon className="w-5 h-5 md:w-4 md:h-4 text-primary" />
                            </div>
                            <span className="text-xl md:text-lg font-bold text-white leading-none">{stat.label}</span>
                            <span className="text-xs md:text-[10px] font-medium text-white/60">{stat.sublabel}</span>
                        </motion.div>
                    ))}
                </div>
                ...
                <motion.div
                    ...
                    className="relative mt-4 md:mt-3 h-0.5 rounded-full overflow-hidden"
                >
