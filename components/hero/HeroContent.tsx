    ...
    return (
        <div className="w-full max-w-2xl">
            ...
            <motion.div
                ...
                className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-yellow-500/10 border border-yellow-500/20 backdrop-blur-sm mb-4"
            >
            ...
            >
                ...
                <Link href="#live-courses" className="w-full sm:w-auto">
                    <motion.button
                ...
                {/* Secondary Button - Free Master Class */}
